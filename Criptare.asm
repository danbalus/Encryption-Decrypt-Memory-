...
mod_citire db "r",0
mod_scriere db "w",0
nume_fisier_scriere db "RezultatCriptare.txt",0
...
start:
	...
	; incepem citirea,criptarea si scrierea in fisier, acestea executandu-se caracter cu caracter
	bucla_citire_criptare_scriere:
	...
	jmp bucla_citire_criptare_scriere ; repeta bucla de citire,criptare,scriere pana ajunge la sfarsitul fisierului
